...
public class UserManager {
	...
	public static void updUserPass(String oldPassWord, String newPassWord, String oldUserName) {
		if (userListMap.containsKey(oldPassWord)) {
			userListMap.remove(oldPassWord);
			userListMap.put(newPassWord, oldUserName);
		}
	 ...
	 */
	public static boolean updUserPassStatus(String newPassWord) {
		User updPassWord = new User();
		updPassWord.status = false;
		if (userListMap.containsKey(newPassWord)) {
